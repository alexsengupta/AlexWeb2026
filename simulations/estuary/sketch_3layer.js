/**
 * sketch_3layer.js
 * Main p5.js sketch for 3-layer model - orchestrates the simulation
 */
...
function setup() {
    ...
    // Initialize 3-layer model
    model = new EstuaryModel_3layer(20);

    // Initialize visualizer (will create its own canvases)
    visualizer = new Visualizer_3layer(model);

    // Initialize charts
    charts = new Charts_3layer(model);

    // Initialize controls (pass visualizer and charts)
    controls = new Controls_3layer(model, visualizer, charts);
